...
namespace Nager.FirewallManagement.Controllers
{
    ...
    public class RemoteDesktopController : ControllerBase
    {
        ...
        private readonly string _ruleName = "Nager.FirewallManagement.RemoteDesktop";

        public RemoteDesktopController(ILogger<RemoteDesktopController> logger)
        {
            this._logger = logger;
        }

        /// <summary>
        /// Create a firewall rule for Microsoft Remote Desktop on port 3389
        /// </summary>
        [HttpPost]
        [Route("AllowAccess")]
        ...
        /// <summary>
        /// Remove firewall rule for Microsoft Remote Desktop
        /// </summary>
        [HttpDelete]
        [Route("RemoveAccess")]
        [ProducesResponseType(StatusCodes.Status204NoContent)]
